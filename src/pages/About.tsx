...
const team = [
  ...
  { name: "AMAN VAGADIYA", role: "Support Lead", initials: "AV", bio: "Ensuring every customer query is resolved with speed and care." },
];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Founded in 2015, EKTA FRIDGE began as a small electronics shop in the heart of Ahmedabad. With a passion for quality and a commitment to customer satisfaction, we quickly grew into one of Gujarat's most trusted appliance retailers.
              </p>
